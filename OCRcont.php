...
define('CSV_FILE_PATH', __DIR__ . '/ocr_cont_results.csv');
define('OCR_LOG_FILE', __DIR__ . '/ocr_cont.log');
...
function extractValidEntries($ocrResult) {
    ...
    foreach ($lines as $line) {
        ...
        // 得点の条件: 10の倍数かつ0以上2000以下
        if (is_numeric($line) && $line >= 0 && $line <= 2000 && $line % 10 === 0) {
            if ($lastName) {
                // ユーザー名とスコアを保存
