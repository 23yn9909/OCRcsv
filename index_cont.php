...
<body>
  <h2>画像アップロードと日付入力（貢献度用）</h2>
    <p>貢献度の得点管理用プログラムです。<br />
    貢献度の得点画面のスクリーンショットを取って、日付と共にアップすると
    OCRを取ってCSVファイルとして出力します。CSVファイルはocr_cont_results.csvとして保存されます。<br />
    ...
    <form id="ocrForm" enctype="multipart/form-data">
        ...
        <label for="images">画像をアップロードしてください （1枚ずつ）:</label>
